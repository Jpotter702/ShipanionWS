#!/bin/bash
# Test script for the get_shipping_quotes ElevenLabs client tool
...
echo -e "${BLUE}=== ElevenLabs get_shipping_quotes Test ===${NC}"
...
# Create a valid client tool call payload for get_shipping_quotes
VALID_TOOL_CALL='{
...
echo -e "\n${YELLOW}Testing get_shipping_quotes tool call...${NC}"
